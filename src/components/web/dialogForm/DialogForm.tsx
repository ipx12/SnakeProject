...
import snakeLogo from '@/assets/icons/snake.svg'
import {
  Select,
  SelectContent,
  SelectItem,
    ...
    return (
      <div className="flex flex-col items-center justify-center py-8 text-center bg-white rounded-2xl p-6">
        ...
        <button
          ...
          className="px-6 py-2.5 bg-[#fee97d] hover:bg-[#fedb4d] text-black font-bold rounded-xl transition-all duration-200 cursor-pointer font-sans text-sm shadow-sm"
        >
    ...
    <div className="w-full bg-white rounded-2xl px-2 py-4 sm:p-6">
      ...
      <div className="flex flex-col items-center justify-center mb-6">
        <img
          ...
          className="w-16 h-16 mb-6"
        />
        <p className="text-zinc-600 font-sans text-center text-sm sm:text-base font-normal leading-relaxed">
                    ...
                    <SelectValue
                      placeholder={
                        <span className="text-zinc-500 font-sans text-sm sm:text-base flex items-center">
                          Contact Method
                          <span className="text-[#a855f7] ml-0.5">
                            *
                          </span>
                        </span>
                      }
