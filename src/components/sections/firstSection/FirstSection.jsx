...
import ElipsAnimation from '@/components/web/elipsAnimation/elipsAnimation'
...
export function FirstSection() {
  ...
  return (
    <section className="relative w-full flex overflow-hidden bg-[#560080] md:bg-gradient-to-br md:from-[#ae5414] md:via-[#430960] md:to-[#120023]">
      <ElipsAnimation className="activateAnimation" contentClassName="text-white px-4 md:px-8 xl:px-13">
        ...
        <div className="relative lg:max-w-[1440px] font-halvar mx-auto w-full z-10 pt-[16px] lg:pt-[30px] lg:pb-[50px] h-full flex flex-col justify-between min-h-screen">
          ...
          <div className="inline-block pointer-events-none select-none absolute bottom-[-8vw] right-[-40px] lg:bottom-[-13vh] z-0">
            <img
              src={firstSnake}
              className="max-w-[unset] w-[110%] h-auto max-h-[600px] lg:w-auto lg:h-[100vh] lg:max-w-[calc(100vw-600px)] lg:max-h-none object-contain"
              alt="Snake"
              draggable={false}
            />
          </div>
